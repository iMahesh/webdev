...
var commentSeed=
    {text: "Bacon ipsum dolor amet beef flank jowl kevin drumstick. Shankle ball tip bresaola ham hock. Andouille cow beef ribs, bacon tenderloin frankfurter rump t-bone picanha bresaola drumstick shankle ham hock landjaeger shank.",
    author: "Andy Wuon"};
        ...
        if (err) {
            ...
            Comment.remove({}, function(err) {
                if (err) {
                    ...
                    campgroundSeed.forEach(function(seed) {
